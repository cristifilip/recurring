...
class RecurlyData {
  ...
  execute(options, callback) {
    console.log('execute called with options: %o', options)
    this._recurring.request(options, function(err, response, body) {
      console.log('execute got response with status code: %s', _.get(response, 'statusCode'))
      console.log('execute got response with body: %O', body)
      if (err) {
